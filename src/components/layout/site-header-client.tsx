  ...
  return (
    <header className="sticky top-0 z-50 border-b border-fawaid-border bg-[rgba(252,251,248,0.96)] backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-7xl flex-nowrap items-center justify-between gap-2 px-4 py-2 md:px-5">
        ...
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-xl border border-fawaid-border p-2 text-fawaid-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fawaid-accent focus-visible:ring-offset-2 lg:hidden"
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                scroll
                className={cn(
                  'whitespace-nowrap rounded-full px-2 py-2 text-xs font-medium transition hover:bg-fawaid-accentSoft hover:text-fawaid-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fawaid-accent xl:px-2.5 xl:text-[13px]',
        ...
        <div className="hidden shrink-0 items-center gap-1.5 lg:ml-auto lg:flex">
          ...
          <ButtonLink href="/admin/login" variant="secondary" className="px-3.5 py-2 text-[13px] leading-none">
            Connexion
          </ButtonLink>
        </div>
      </div>
      ...
      >
        <nav className="mx-auto flex w-full max-w-6xl flex-col gap-1 px-4 py-3" aria-label="Navigation mobile">
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  'rounded-xl px-3 py-2 text-sm font-medium transition hover:bg-fawaid-accentSoft hover:text-fawaid-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fawaid-accent',
                  active ? 'bg-fawaid-accentSoft text-fawaid-accent' : 'text-fawaid-muted'
                )}
              >
                {item.label}
          ...
          <div className="mt-2 grid gap-2">
            <ButtonLink href={siteConfig.inscriptionUrl} target="_blank" rel="noopener noreferrer" className="w-full">
              {siteConfig.cta.signup}
            </ButtonLink>
            <Link
              href="/admin/login"
